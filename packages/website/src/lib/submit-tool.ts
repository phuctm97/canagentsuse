...
export function buildSubmitToolAgentPrompt(input: SubmitToolInput) {
  ...
  return [
    ...
    "8. Do not set `agentScore`; it is computed automatically from evidence by the repo's scoring algorithm. Add caution notes for money, production data, accounts, compliance, infrastructure, browser-only flows, or brittle automation.",
